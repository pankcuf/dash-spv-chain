...
pub struct MasternodeProcessorCache {
    pub llmq_members: BTreeMap<common::LLMQType, BTreeMap<UInt256, Vec<masternode::MasternodeEntry>>>,
    pub llmq_indexed_members: BTreeMap<common::LLMQType, BTreeMap<masternode::LLMQIndexedHash, Vec<masternode::MasternodeEntry>>>,
    pub mn_lists: BTreeMap<UInt256, masternode::MasternodeList>,
    pub llmq_snapshots: BTreeMap<UInt256, masternode::LLMQSnapshot>,
...
impl MasternodeProcessorCache {
    ...
    pub fn add_snapshot(&mut self, block_hash: UInt256, snapshot: masternode::LLMQSnapshot) {
    ...
    ) -> Option<&mut BTreeMap<UInt256, Vec<masternode::MasternodeEntry>>> {
    ...
    pub fn get_indexed_quorum_members_of_type(
        &mut self,
        r#type: common::LLMQType,
    ) -> Option<&mut BTreeMap<masternode::LLMQIndexedHash, Vec<masternode::MasternodeEntry>>> {
    ...
    pub fn get_quorum_members(
        ...
        r#type: common::LLMQType,
        block_hash: UInt256,
    ) -> Option<Vec<masternode::MasternodeEntry>> {
