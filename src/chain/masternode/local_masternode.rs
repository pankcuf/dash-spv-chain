...
pub struct LocalMasternode {
    ...
    pub provider_update_registrar_transactions: Vec<&'static ProviderUpdateRegistrarTransaction>,
    pub provider_update_service_transactions: Vec<&'static ProviderUpdateServiceTransaction>,
    pub provider_update_revocation_transactions: Vec<&'static ProviderUpdateRevocationTransaction>,
}
...
impl LocalMasternode {
    ...
    pub fn operator_key_from_seed(&self, seed: Vec<u8>) -> Option<BLSKey> {
        self.operator_keys_wallet.and_then(|wallet| self.provider_registration_transaction.and_then(|tx| {
            ...
            path.private_key_for_hash160::<BLSKey>(hash, seed)
        }))
    }
