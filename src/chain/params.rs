...
pub const MAINNET_PARAMS: Params = Params {
    ...
    max_proof_of_work: UInt256::from_hex("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff").unwrap().reversed(),
...
pub fn create_devnet_params_for_type(r#type: DevnetType) -> Params {
    Params {
        ...
        max_proof_of_work: UInt256::from_hex("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff").unwrap().reversed(),
